...
<table width="100%">
	...
	<TR>
		...
		<TD>
			<a href="<?=$this->make_report_link('visitors_report.php', array('owa_page' => 'visitor_list', 'year2' => $row['first_session_year'], 'month2' => $row['first_session_month'], 'day2' => $row['first_session_day'], 'period' => $params['period']));?>">
			<?=$row['count'];?></a>
		</TD>
	</TR>
	<? endforeach;?>
