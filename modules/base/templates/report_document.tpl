...
<div class="owa_reportSectionContent">
	<table>
		<TR>
			...
			<P>
				<span class="inline_h3"><a href="<?php echo $this->makeLink(array('do' => 'base.overlayLauncher', 'url' => urlencode($detail['url']), 'overlay_action' => 'heatmap'), true);?>" target="_blank">Overlay</a></span>
			</P>
