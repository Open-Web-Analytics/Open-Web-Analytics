...
<table width="100%">
	<TR>
		...
		<TD width="33%" valign="top">
			...
			<P>
				<span class="inline_h3"><a href="<?=$this->makeLink(array('do' => 'base.reportVisitorsLoyalty'));?>">Visitor Loyalty</a></span> - Seehow long ago your visitors first came to your web site.
			</P>
			<P>
