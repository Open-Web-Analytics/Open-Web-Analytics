...
<form method="post" name="owa_options">
	...
	<div class="setting" id="log_named_users">	
		...
		<div class="field">
			<SELECT NAME="<?php echo $this->getNs();?>config[log_named_users]">
	...
	<div class="setting" id="fetch_refering_page_info">	
		...
		<div class="field">
			<select name="<?php echo $this->getNs();?>config[fetch_refering_page_info]">
    ...
    <fieldset name="owa-options" class="options">
		...
		<div class="setting" id="notice_email">	
			...
			<div class="field"><input size="50" type="text" name="<?php echo $this->getNs();?>config[notice_email]" value="<?php echo $config['notice_email']?>"></div>
    ...
    <fieldset name="owa-geolocation-options" class="options">
		...
		<div class="setting" id="google_maps_api_key">
			...
			<div class="field"><input type="text" size="90" name="<?php echo $this->getNs();?>config[google_maps_api_key]" value="<?php echo $config['google_maps_api_key']?>"></div>
		</div>
	...
	<fieldset name="owa-feed-options" class="options">
		...
		<div class="setting" id="feeds">	
			...
			<div class="field">
				<select name="<?php echo $this->getNs();?>config[track_feed_links]">
    ...
    <fieldset name="owa-event-options" class="options">
		...
		<div class="setting" id="async_db">	
			...
			<div class="field">
				<select name="<?php echo $this->getNs();?>config[async_db]">
		...
		<div class="setting" id="async_log_dir">	
			...
			<div class="field"><input type="text" size="80" name="<?php echo $this->getNs();?>config[async_log_dir]" value="<?php echo $config['async_log_dir']?>"></div>
		</div>
	...
	<fieldset name="owa-reports-options" class="options">
		...
		<div class="setting" id="click_drawing_mode">	
			...
			<div class="field">
				<select name="<?php echo $this->getNs();?>config[click_drawing_mode]">
