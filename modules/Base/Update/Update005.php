...
class Update005 extends \OWA\Core\Update {
    ...
    function up() {
        ...
        $visitor = \OWA\Core\CoreAPI::entityFactory('base.visitor');
    ...
    function down() {
        ...
        $feed_request = \OWA\Core\CoreAPI::entityFactory('base.feed_request');
        $feed_request->dropColumn('yyyymmdd');
        $u = \OWA\Core\CoreAPI::entityFactory('base.user');
        $u->dropColumn('api_key');
        $u = \OWA\Core\CoreAPI::entityFactory('base.document');
        $u->dropColumn('uri');
        $af = \OWA\Core\CoreAPI::entityFactory('base.action_fact');
        $af->dropTable();
        $st = \OWA\Core\CoreAPI::entityFactory('base.search_term_dim');
        $st->dropTable();
