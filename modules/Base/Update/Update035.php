...
/**
 * Create owa_event, v2's denormalised event table.
 *
 * Empty, and written only by cmd=events-rebuild, so this adds storage and
 ...
 * of them, and the pass cannot publish a rebuild into a table with no
 * partitions to exchange.
 */
class Update035 extends \OWA\Core\Update {
     ...
     * Drop it.
     *
     * The exact inverse: everything in it was derived by the pass from
