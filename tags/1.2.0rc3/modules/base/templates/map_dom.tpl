...
<div class="owa_map-container">
	<img align="bottom" src="<?=$this->makeImageLink('kml_feed_small.png');?>"> <a class="owa_map-type-control" maptype="earth" href="#">View in Google Earth</a><BR><BR>
...
OWA.items['map'].markers[<?=$k;?>] = {pointLatLng: [<?=trim($visit['host_latitude']);?>, <?=trim($visit['host_longitude']);?>], pointHTML: '<?php echo preg_replace("/[\n\r]/", '', $this->subTemplate('report_visit_summary_balloon.tpl', array('visit' => $visit)));?>'};
<?php endif;?>
<?php endforeach;?>
...
<div class="error">
	You must have a Google Maps API Key to use this feature. Google provides this key for free. You can get a key in <b>minutes</b> by visiting <a href="http://www.google.com/apis/maps/signup.html" target="_blank">this Google web site</a> and then entering the key on the <a href="<?=$this->makeLink(array('view' => 'base.options'));?>">main OWA configuration page</a>.
</div>
