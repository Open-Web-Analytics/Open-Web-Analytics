...
class owa_trafficSummaryTrend extends owa_metric {
	
	function owa_trafficSummaryTrend($params = null) {
		
		return owa_trafficSummaryTrend::__construct($params);
