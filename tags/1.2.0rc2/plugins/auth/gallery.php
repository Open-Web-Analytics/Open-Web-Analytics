...
class owa_auth_gallery extends owa_auth {
	
	function owa_auth_gallery() {
	...
	function getUser() {
		...
		$this->u->email_address = $this->params['caller']['gallery']['user_data']['user_email'];
		$this->u->real_name = $this->params['caller']['gallery']['user_data']['user_identity'];
		$this->u->user_id = $this->params['caller']['gallery']['user_data']['user_login'];
		$this->u->password = $this->params['caller']['gallery']['user_data']['user_pass_md5'];
	...
	function isUser() {
		...
		$this->mapPriviledgeLevel($this->params['caller']['gallery']['user_data']['user_level']);	
