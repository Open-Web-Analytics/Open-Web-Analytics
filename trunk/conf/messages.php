...
3311 => array("These required updates must be applied using the command line interface (CLI). Run <code>'/path/to/php cli.php cmd=update'</code> from your server's command shell. For more information on updating see the install/update page on the wiki.",0),
// Graph related
