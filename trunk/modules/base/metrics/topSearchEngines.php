...
class owa_topSearchEngines extends owa_metric {


	function owa_topSearchEngines($params = null) {

		return owa_topSearchEngines::__construct($params);
	...
	function calculate() {
		...
		$this->db->selectColumn("count(referer.id) as count,
								...
								url, page_title, site_name, query_terms, snippet, refering_anchortext, is_searchengine");
