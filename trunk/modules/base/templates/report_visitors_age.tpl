...
<table width="100%">
	...
	<TR>
		...
		<TD>
			<a href="<?=$this->makeLink(array('do' => 'base.reportVisitorsList','year2' => $row['first_session_year'], 'month2' => $row['first_session_month'], 'day2' => $row['first_session_day'], 'period' => $params['period']));?>">
			<?=$row['count'];?></a>
		</TD>
	</TR>
	<? endforeach;?>
